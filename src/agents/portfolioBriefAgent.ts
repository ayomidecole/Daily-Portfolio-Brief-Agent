...
import { getUpcomingPortfolioEventsTool } from "../tools/getUpcomingPortfolioEvents.js";
...
export const portfolioBriefAgent = createAgent({
    ...
    tools: [
        ...
        getUpcomingPortfolioEventsTool,
    ],
    ...
    Always use get_upcoming_portfolio_events for upcoming events. Do not sort or filter event dates yourself.
